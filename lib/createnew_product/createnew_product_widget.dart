...
import 'createnew_product_model.dart';
export 'createnew_product_model.dart';

class CreatenewProductWidget extends StatefulWidget {
  const CreatenewProductWidget({super.key});

  @override
  State<CreatenewProductWidget> createState() => _CreatenewProductWidgetState();
}

class _CreatenewProductWidgetState extends State<CreatenewProductWidget> {
  late CreatenewProductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreatenewProductModel());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Ingrese nombre del Prodcuto',
                        hintStyle:
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Ingrese Descripcion delro Pducto',
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.uploadedphoto = await ProductsTable().insert({
