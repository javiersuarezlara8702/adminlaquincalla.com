...
import 'updatephoto_copy2_model.dart';
export 'updatephoto_copy2_model.dart';

class UpdatephotoCopy2Widget extends StatefulWidget {
  const UpdatephotoCopy2Widget({
    super.key,
  ...
  @override
  State<UpdatephotoCopy2Widget> createState() => _UpdatephotoCopy2WidgetState();
}

class _UpdatephotoCopy2WidgetState extends State<UpdatephotoCopy2Widget> {
  late UpdatephotoCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdatephotoCopy2Model());
  }
