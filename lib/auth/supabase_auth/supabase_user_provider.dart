...
class AdmininsumoslaquincallaSupabaseUser extends BaseAuthUser {
  AdmininsumoslaquincallaSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> admininsumoslaquincallaSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          AdmininsumoslaquincallaSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
