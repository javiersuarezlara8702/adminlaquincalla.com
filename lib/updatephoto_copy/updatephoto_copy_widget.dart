...
import 'updatephoto_copy_model.dart';
export 'updatephoto_copy_model.dart';

class UpdatephotoCopyWidget extends StatefulWidget {
  const UpdatephotoCopyWidget({
    super.key,
    required this.id,
  ...
  @override
  State<UpdatephotoCopyWidget> createState() => _UpdatephotoCopyWidgetState();
}

class _UpdatephotoCopyWidgetState extends State<UpdatephotoCopyWidget> {
  late UpdatephotoCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdatephotoCopyModel());
  }
